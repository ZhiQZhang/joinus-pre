        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="searchParams.order.includes('1') ? 'active' : ''">
                  <a @click="zhHandler"
                    >综合
                    <span
                      v-show="
                        searchParams.order.includes('1') &&
                    ...
                    <span
                      v-show="
                        searchParams.order.includes('1') &&
                        searchParams.order.includes('asc')
                          ? 'active'
                          : ''
                      "
                      >⬆</span
                ...
                <li :class="searchParams.order.includes('2') ? 'active' : ''">
                  <a @click="priceHandler"
                    >价格
                    <span
                      v-show="
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  <div class="p-img">
                    <a @click="routerTo(good.id)" to="detail"><img :src="good.defaultImg"
                    /></a>
                  </div>
                  <div class="price">
                    <strong>
