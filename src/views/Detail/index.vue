<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin" style="text-align:left;">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <ZoomCom :skuImageList="skuImageList" />
          <!-- 小图列表 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd @click="changeActive(saleAttrValue, spuSaleAttr.spuSaleAttrValueList)" changepirce="0" :class="saleAttrValue.isChecked === '1'?'active':''"
                v-for="saleAttrValue in spuSaleAttr.spuSaleAttrValueList"
                :key="saleAttrValue.id">{{saleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" @blur="changeCount" v-model.number="skuNum" />
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" :style="skuNum <= 1?'pointer-events: none;':''" class="mins" @click="skuNum--" disabled>-</a>
              </div>
              <div class="add">
...
import ZoomCom from '@/views/Detail/Zoom/Zoom.vue'
