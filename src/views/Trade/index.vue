  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="detail in detailList" :key="detail.skuId">
          <li>
            <img :src="detail.imgUrl" alt="" width="100px" height="100px" />
          </li>
          <li>
            <p>
              {{detail.skuName}}
      ...
      <div class="bbs">
        <h5 style="text-align:left;">买家留言：</h5>
        <textarea
          v-model="text"
      ...
      <div class="line"></div>
      <div class="bill" style="text-align:left;">
        <h5>发票信息：</h5>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span style="color:red;">{{DefaultPerson.userAddress}}</span>
        收货人：<span style="color:red;">{{DefaultPerson.consignee}}</span>
        电话：<span style="color:red;">{{DefaultPerson.phoneNum}}</span>
      </div>
    </div>
  ...
  methods: {
    ...
    async submitTrade () {
      let data = {
        ...
        deliveryAddress: this.DefaultPerson.userAddress,
        paymentWay: 'ONLINE',
        orderComment: this.text,
        orderDetailList: this.detailList
      }
      await this.$API.reqSubmitOrder(this.tradeInfo.tradeNo, data).then(
        res => {
